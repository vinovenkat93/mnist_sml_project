...
plt.savefig('Neural_net_alpha_mean_acc.png', dpi = 600)
plt.show()  
...
plt.title(r'$\alpha$ (regularization) optimization using the 10-fold CV') 
plt.savefig('Neural_net_alpha_var_acc.png', dpi = 600)
plt.show() 
...
plt.savefig('Neural_net_act_fcn_mean_acc.png', dpi = 600)
plt.show()  
...
plt.savefig('Neural_net_act_fcn_var_acc.png', dpi = 600)
plt.show()  
...
plt.savefig('Neural_net_learn_rate_mean_acc.png', dpi = 600)
plt.show()  
...
plt.gca().set(xlabel=r'Learning rate ($\eta$)', ylabel='Mean Accuracy (10-fold CV)')
plt.title(r'Learning rate ($\eta$) optimization using the 10-fold CV') 
plt.savefig('Neural_net_learn_rate_var_acc.png', dpi = 600)
plt.show() 