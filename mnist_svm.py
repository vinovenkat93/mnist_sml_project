...
for k in np.arange(1000,60000,1000):    
    ...
    print "Number of training samples: {}".format(k)
    ...
    print "Execution Time for SVM (RBF Kernel): {}".format(execTime)                         
    print "Accuracy: " + metrics.accuracy_score(mnist_test_k.targets, y_pred)
    ...
    print "Accuracy: {}".format(metrics.accuracy_score(mnist_test_k.targets, y_pred))
